                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp animated" data-wow-delay="200ms">
                        <div class="feature-one__item">
                            ...
                            <div class="feature-one__item__hover-content">
                                ...
                                <p class="feature-one__item__hover-content--text">This present moment is perfect simply due to the fact.</p>
                                <a class="feature-one__item__hover-content__btn" href="website-development.html">Read More<span class="icon-down-right"></span></a>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp animated" data-wow-delay="300ms">
                        <div class="feature-one__item">
                            ...
                            <div class="feature-one__item__hover-content">
                                ...
                                <p class="feature-one__item__hover-content--text">This present moment is perfect simply due to the fact.</p>
                                <a class="feature-one__item__hover-content__btn" href="graphic-designing.html">Read More<span class="icon-down-right"></span></a>
                            </div><!-- feature hover content -->
                        </div><!-- feature item end -->
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp animated" data-wow-delay="400ms">
                        <div class="feature-one__item">
                            ...
                            <div class="feature-one__item__hover-content">
                                ...
                                <p class="feature-one__item__hover-content--text">This present moment is perfect simply due to the fact.</p>
                                <a class="feature-one__item__hover-content__btn" href="digital-marketing.html">Read More<span class="icon-down-right"></span></a>
                            </div><!-- feature hover content -->
                        </div><!-- feature item end -->
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="about-one__content">
                            ...
                            <p class="about-one__content__text-one">There are many variations of simply free text passages of available but the majority have suffered alteration in some form, by injected hum randomised words which don't slightly.</p>
                            <p class="about-one__content__text-two">Sed ut perspiciatis unde omnis iste natus error voluptatem accusantium doloremque laudantium totam reme aperiam.</p>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 wow fadeInUp animated" data-wow-delay="100ms">
                        <div class="service-one__item">
                            ...
                            <p class="service-one__item__text">Providing the solutions for your all business</p><!-- /.service-content -->
                            <a class="service-one__item__btn" href="website-development.html">Read More<span class="icon-down-right"></span></a><!-- /.service-read-more -->
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp animated" data-wow-delay="200ms">
                        <div class="service-one__item">
                            ...
                            <p class="service-one__item__text">Providing the solutions for your all business</p><!-- /.service-content -->
                            <a class="service-one__item__btn" href="graphic-designing.html">Read More<span class="icon-down-right"></span></a><!-- /.service-read-more -->
                        </div><!-- /.service-card-one -->
                    </div>
                    <div class="col-lg-3 col-md-6 wow fadeInUp animated" data-wow-delay="100ms">
                        <div class="service-one__item">
                            ...
                            <p class="service-one__item__text">Providing the solutions for your all business</p><!-- /.service-content -->
                            <a class="service-one__item__btn" href="digital-marketing.html">Read More<span class="icon-down-right"></span></a><!-- /.service-read-more -->
                        </div><!-- /.service-card-one -->
                    </div>
                    <div class="col-lg-3 col-md-6 wow fadeInUp animated" data-wow-delay="100ms">
                        <div class="service-one__item">
                            ...
                            <p class="service-one__item__text">Providing the solutions for your all business</p><!-- /.service-content -->
                            <a class="service-one__item__btn" href="apps-development.html">Read More<span class="icon-down-right"></span></a><!-- /.service-read-more -->
                        </div><!-- /.service-card-one -->
                    </div>
                </div>
            </div>
        ...
        <section class="project-one @@extraClassName">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a href="project-details.html" class="project-one__item wow fadeInUp animated animated" data-wow-delay="100ms">
                            <div class="project-one__item__wrapper">
                                ...
                                <div class="project-one__item__btn"><span class="icon-down-right"></span></div><!-- /.project-btn -->
                                <div class="project-one__item__hover"><img class="project-one__item__hover--img" src="assets/images/project/project-1-1.jpg" alt="ogency"></div><!-- /.project-hover-image -->
                            </div>
                        </a><!-- /.project-item-one -->
                        <a href="project-details.html" class="project-one__item wow fadeInUp animated animated" data-wow-delay="200ms">
                            <div class="project-one__item__wrapper">
                                <span class="project-one__item__number"></span>
                                <h3 class="project-one__item__title">UI / UX Design for technology</h3><!-- /.project-title -->
                                <div class="project-one__item__btn"><span class="icon-down-right"></span></div><!-- /.project-btn -->
                                <div class="project-one__item__hover"><img class="project-one__item__hover--img" src="assets/images/project/project-1-2.jpg" alt="ogency"></div><!-- /.project-hover-image -->
                            </div>
                        </a><!-- /.project-item-one -->
                        <a href="project-details.html" class="project-one__item wow fadeInUp animated animated" data-wow-delay="300ms">
                            <div class="project-one__item__wrapper">
                                <span class="project-one__item__number"></span>
                                <h3 class="project-one__item__title">Crown digial agency site</h3><!-- /.project-title -->
                                <div class="project-one__item__btn"><span class="icon-down-right"></span></div><!-- /.project-btn -->
                                <div class="project-one__item__hover"><img class="project-one__item__hover--img" src="assets/images/project/project-1-3.jpg" alt="ogency"></div><!-- /.project-hover-image -->
                            </div>
                        </a><!-- /.project-item-one -->
                        <a href="project-details.html" class="project-one__item wow fadeInUp animated animated" data-wow-delay="400ms">
                            <div class="project-one__item__wrapper">
                                <span class="project-one__item__number"></span>
                                <h3 class="project-one__item__title">Creative marketing</h3><!-- /.project-title -->
                                <div class="project-one__item__btn"><span class="icon-down-right"></span></div><!-- /.project-btn -->
                                <div class="project-one__item__hover"><img class="project-one__item__hover--img" src="assets/images/project/project-1-4.jpg" alt="ogency"></div><!-- /.project-hover-image -->
                            </div>
                        </a><!-- /.project-item-one -->
                    </div>
                </div>
        ...
        <section class="team-one">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6 wow fadeInUp animated" data-wow-delay="200ms">
                        <div class="team-one__item">
                            <div class="team-one__item__image">
                    ...
                    <div class="col-xl-3 col-md-6 wow fadeInUp animated" data-wow-delay="300ms">
                        <div class="team-one__item">
                            <div class="team-one__item__image">
                    ...
                    <div class="col-xl-3 col-md-6 wow fadeInUp animated" data-wow-delay="400ms">
                        <div class="team-one__item">
                            <div class="team-one__item__image">
                                <img src="assets/images/team/team-1-4.jpg" alt="ogency">
                            </div><!-- /.team-image -->
                            <div class="team-one__item__content">
                                <span class="team-one__item__designation">Senior Designer</span><!-- /.team-designation -->
                                <h3 class="team-one__item__title">
        ...
        <!--Sliding Text Start -->
        <!--Testimonial Start-->
        <section class="testimonial-one" style="background-image: url(assets/images/backgrounds/testimonial-bg-1.png);">
            <div class="container">
            ...
            "navText": ["<span class=\"icon-left-arrow\"></span>","<span class=\"icon-right-arrow\"></span>"]
                    ...
                    <div class="testimonial-one__item">
                        ...
                        <div class="testimonial-one__item__content">
                            ...
                            <div class="testimonial-one__item__meta">Christine eve<span>.&nbsp;&nbsp;Customer</span></div><!-- testimonial-meta -->
                    ...
                    <div class="testimonial-one__item">
                        ...
                        <div class="testimonial-one__item__content">
                            ...
                            <div class="testimonial-one__item__meta">Delia riley<span>.&nbsp;&nbsp;Customer</span></div><!-- testimonial-meta -->
                        </div><!-- testimonial-content -->
                    </div>
                    <!-- Testimonial Item -->
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 wow fadeInUp" data-wow-delay="100ms">
                        <div class="section-title text-center">
                            <h5 class="section-title__tagline section-title__tagline--has-dots">our recent posts</h5>
                            <h2 class="section-title__title">Our latest news &<br> articles from the blog</h2>
                        </div><!-- section-title -->
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="blog-one__item">
                            <div class="blog-one__item__image">
                                <img src="assets/images/blog/blog-1-1.jpg" alt="Trending web code settings for a nice portfolio">
                                <a href="blog-details.html"></a>
                                <span>16 apr</span>
                            </div><!-- /.blog-image -->
                            <div class="blog-one__item__content">
                                <div class="blog-one__item__meta has-border"><a href="blog-details.html">Design</a><span>.</span>2 Comments</div><!-- /.blog-meta -->
                                <h3 class="blog-one__item__title">
                                    <a href="blog-details.html">Trending web code settings for a nice portfolio</a>
                                </h3><!-- /.blog-title -->
                                <a class="blog-one__item__btn" href="blog-details.html">Read More<span class="icon-down-right"></span></a><!-- /.blog-read-more -->
                            </div><!-- /.blog-content -->
                        </div><!-- /.blog-card-one -->
                    </div>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="blog-one__item">
                            ...
                            <div class="blog-one__item__content">
                                <div class="blog-one__item__meta has-border"><a href="blog-details.html">Design</a><span>.</span>2 Comments</div><!-- /.blog-meta -->
                                <h3 class="blog-one__item__title">
                                    <a href="blog-details.html">Get a few solutions to hire a best candidate</a>
                                </h3><!-- /.blog-title -->
                                <a class="blog-one__item__btn" href="blog-details.html">Read More<span class="icon-down-right"></span></a><!-- /.blog-read-more -->
                            </div><!-- /.blog-content -->
                        </div><!-- /.blog-card-one -->
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <div class="blog-one__item">
                            ...
                            <div class="blog-one__item__content">
                                <div class="blog-one__item__meta has-border"><a href="blog-details.html">Design</a><span>.</span>2 Comments</div><!-- /.blog-meta -->
                                <h3 class="blog-one__item__title">
                                    <a href="blog-details.html">Introducing the latest tech features for you</a>
                                </h3><!-- /.blog-title -->
                                <a class="blog-one__item__btn" href="blog-details.html">Read More<span class="icon-down-right"></span></a><!-- /.blog-read-more -->
                            </div><!-- /.blog-content -->
                        </div><!-- /.blog-card-one -->
